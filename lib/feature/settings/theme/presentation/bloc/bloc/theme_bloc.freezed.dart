...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _Load value)?  load,TResult Function( _Changed value)?  changed,required TResult orElse(),}){
final _that = this;
switch (_that) {
case _Load() when load != null:
return load(_that);case _Changed() when changed != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _Load value)  load,required TResult Function( _Changed value)  changed,}){
final _that = this;
switch (_that) {
case _Load():
return load(_that);case _Changed():
return changed(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _Load value)?  load,TResult? Function( _Changed value)?  changed,}){
final _that = this;
switch (_that) {
case _Load() when load != null:
return load(_that);case _Changed() when changed != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  load,TResult Function( ThemeMode mode)?  changed,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Load() when load != null:
return load();case _Changed() when changed != null:
return changed(_that.mode);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  load,required TResult Function( ThemeMode mode)  changed,}) {final _that = this;
switch (_that) {
case _Load():
return load();case _Changed():
return changed(_that.mode);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  load,TResult? Function( ThemeMode mode)?  changed,}) {final _that = this;
switch (_that) {
case _Load() when load != null:
return load();case _Changed() when changed != null:
return changed(_that.mode);case _:
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Changed&&(identical(other.mode, mode) || other.mode == mode));
}
...
/// @nodoc
abstract mixin class _$ChangedCopyWith<$Res> implements $ThemeEventCopyWith<$Res> {
